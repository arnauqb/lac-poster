...
\usepackage[orientation=portrait,size=a1,scale=1.5]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size
...
%   TITLE SECTION 
%----------------------------------------------------------------------------------------
\title{\Huge Large Agent Collider\\ Understanding complexity from the bottom-up} % Poster title
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{column}{.4\textwidth} % 1st column
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{column}{.55\textwidth} % 2nd column
    \vspace{\shrink}
